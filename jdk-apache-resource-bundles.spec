...
#
Name     : jdk-apache-resource-bundles
Version  : 2
Release  : 1
URL      : https://github.com/apache/maven-resources/archive/apache-resource-bundles-2.tar.gz
Source0  : https://github.com/apache/maven-resources/archive/apache-resource-bundles-2.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-apache-resource-bundles-data
...
%package data
Summary: data components for the jdk-apache-resource-bundles package.
Group: Data

%description data
data components for the jdk-apache-resource-bundles package.


%prep
%setup -q -n maven-resources-apache-resource-bundles-2

python3 /usr/share/java-utils/mvn_file.py :apache-jar-resource-bundle apache-resource-bundles/jar
python3 /usr/share/java-utils/mvn_file.py :apache-license-header-resource-bundle apache-resource-bundles/license-header
python3 /usr/share/java-utils/mvn_file.py :apache-incubator-disclaimer-resource-bundle apache-resource-bundles/incubator-disclaimer

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n apache-resource-bundles -d %{buildroot}
...
%files data
%defattr(-,root,root,-)
/usr/share/java/apache-resource-bundles/incubator-disclaimer.jar
/usr/share/java/apache-resource-bundles/jar.jar
/usr/share/java/apache-resource-bundles/license-header.jar
/usr/share/maven-metadata/apache-resource-bundles.xml
/usr/share/maven-poms/apache-resource-bundles/apache-resource-bundles.pom
/usr/share/maven-poms/apache-resource-bundles/incubator-disclaimer.pom
/usr/share/maven-poms/apache-resource-bundles/jar.pom
/usr/share/maven-poms/apache-resource-bundles/license-header.pom
